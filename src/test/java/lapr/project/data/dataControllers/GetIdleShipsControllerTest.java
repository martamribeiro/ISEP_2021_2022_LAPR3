...
class GetIdleShipsControllerTest {
    private DatabaseConnection databaseConnection;
    private GetIdleShipsController ctrl;

    @BeforeEach
    void setUp() {
        databaseConnection = mock(DatabaseConnection.class);
        ctrl = mock(GetIdleShipsController.class);
    }
    ...
    void getIdleShips() {
        ...
        when(ctrl.getIdleShips()).thenReturn(sb.toString());
        String result = ctrl.getIdleShips();
